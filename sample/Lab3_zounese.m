...
% location of the root since the number of iterations is dependent on the 
% length of the interval and its error tolerance. 
...
newton((x^5 - x^4 + x -1), (5*x^4 - 4*x^3 + 1), 0, 10^-6, 100)
...
% approximating roots when they are very large can introduce too much error. 
